...
1. 根据表格找到你的需要的SSDT文件  
   ...
   ![这里只是台式机的](/image/img/20210727153905.png)
...
![](/image/img/macos恢复界面.png)
3. 选择`磁盘工具`，选择你上一步格式化的磁盘，点击`抹掉`，格式选择`APFS`
![](/image/img/macos磁盘工具格式化磁盘.png)
